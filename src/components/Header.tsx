          ...
          <div className="flex items-center space-x-4">
            <div className="hidden md:block">
              <Input
                ...
                className="w-72 bg-slate-50/80 border-slate-200 focus:bg-white focus:border-blue-300 focus:ring-blue-200 transition-all duration-200 rounded-xl"
              />
            </div>
            <Button 
              variant="outline" 
              className="bg-slate-800 text-white hover:bg-slate-700 border-slate-800 hover:border-slate-700 rounded-xl px-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
            >
              Sign In
            </Button>
          </div>
